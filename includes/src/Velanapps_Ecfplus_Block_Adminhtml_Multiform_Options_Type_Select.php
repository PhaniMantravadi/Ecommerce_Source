<?php
class Velanapps_Ecfplus_Block_Adminhtml_Multiform_Options_Type_Select extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Options_Type_Select
{
    /**
     * Class constructor
     */
    ...
    {
        $this->setTemplate('ecfplus/options/type/select.phtml');
