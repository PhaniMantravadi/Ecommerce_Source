...
class Cminds_Marketplace_Block_Adminhtml_Supplier_List_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        $collection = Mage::getResourceModel('customer/customer_collection')
            ...
            ->addAttributeToSelect('supplier_profile_approved')
    ...
    protected function _prepareColumns()
    {
       ...
       /* $this->addColumn('productlist',
            array(
                'header'    => Mage::helper('customer')->__('Product List'),
                'width'     => '80px',
                'type'      => 'action',
                'getter'     => 'getId',
                'actions'   => array(
                    array(
                        'caption' => Mage::helper('customer')->__('Product List'),
                        'url'     => array(
                            'base'=>'adminhtml/suppliers/productlist'
                        ),
                        'field'   => 'id'
                    )
                ),
        ...
        $this->addColumn('processfile',
            array(
                'header'    => Mage::helper('customer')->__('CSV File Lists'),
                'width'     => '80px',
                'type'      => 'action',
                'getter'     => 'getId',
                'actions'   => array(
                    array(
                        'caption' => Mage::helper('customer')->__('CSV File List'),
                        'url'     => array(
                            'base'=>'adminhtml/suppliers/processcsv'
                        ),
                        'field'   => 'id'
                    )
                ),
