...
class Cminds_Supplierfrontendproductuploader_Adminhtml_Supplier_ProductController extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function _isAllowed() {
        return Mage::getSingleton('admin/session')->isAllowed('admin/catalog/supplierfrontendproductuploader_catalog_product');
    }
    ...
    private function approve($id) {
        try {
            ...
            $p->setWebsiteIds(array(self::CULTURES_WEBSITE_ID));
            $p->save();
            ...
            $stockStatus->assignProduct($p);
            $stockStatus->saveProductStatus($p->getId(), 1);
