...
class Cminds_Marketplacecustom_Block_Adminhtml_Customer_Edit_Tabs extends Mage_Adminhtml_Block_Customer_Edit_Tabs
{
    protected function _beforeToHtml()
    {
        if(Mage::helper('marketplace')->isSupplier(Mage::registry('current_customer')->getId())) {
            ...
            $this->addTabAfter('payment_profile', array(
                'label'     => Mage::helper('marketplace')->__('Supplier Payment Profile'),
                'class'     => 'ajax',
                'url'       => $this->getUrl('*/marketplacesettings/paymentprofile', array('_current' => true)),
            ),'supplier_profile');
            ...
            $this->addTabAfter('supplier_profile_custom', array(
                'label'     => Mage::helper('marketplace')->__('Registration Profile'),
                'class'     => 'ajax',
                'url'       => $this->getUrl('*/marketplacesettings/registration', array('_current' => true)),
            ),'assigned_categories');
        }
