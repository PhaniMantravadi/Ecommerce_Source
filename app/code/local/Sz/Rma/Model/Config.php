 ...
 */
class Sz_Rma_Model_Config extends Varien_Object
{
    /**
     * XML configuration paths
     */
    const XML_PATH_RMA_EMAIL                    = 'sales_email/sz_rma';
    const XML_PATH_AUTH_EMAIL                   = 'sales_email/sz_rma_auth';
    const XML_PATH_COMMENT_EMAIL                = 'sales_email/sz_rma_comment';
    const XML_PATH_CUSTOMER_COMMENT_EMAIL       = 'sales_email/sz_rma_customer_comment';
     ...
     */
    const XML_PATH_CUSTOMER_COMMENT_EMAIL_RECIPIENT = 'sales_email/sz_rma_customer_comment/recipient';
