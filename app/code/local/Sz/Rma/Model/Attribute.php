 ...
 */
class Sz_Rma_Model_Attribute extends Mage_Eav_Model_Entity_Attribute
{
    /**
     * Name of the module
     */
    const MODULE_NAME = 'Sz_Rma';
     ...
     * @var string
     */
    protected $_eventPrefix = 'sz_rma_entity_attribute';
    ...
    {
        $this->_init('sz_rma/item_attribute');
    }
