 ...
 */
class Sz_Rma_Model_Shipping_Info extends Varien_Object
{
    /**
     * Tracking info
     *
    ...
    {
        $data = Mage::helper('sz_rma')->decodeTrackingHash($hash);
    ...
    {
        $track = Mage::getModel('sz_rma/shipping')->load($this->getTrackId());
