 ...
 */
class Sz_Rma_Model_Resource_Rma_Grid_Collection extends Sz_Rma_Model_Resource_Rma_Collection
{
/**
     * Event prefix
     *
    ...
    {
        parent::_construct();
        $this->setMainTable('sz_rma/rma_grid');
    }
     ...
     * @return Sz_Rma_Model_Resource_Rma_Grid_Collection
     */
