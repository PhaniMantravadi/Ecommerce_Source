 ...
 */
class Sz_Rma_Model_Resource_Setup extends Mage_Sales_Model_Resource_Setup
{
    /**
    ...
    public function getDefaultEntities()
    {
        $entities = array(
            'rma_item'                           => array(
                'entity_model'                   => 'sz_rma/item',
                'attribute_model'                => 'sz_rma/item_attribute',
                'table'                          => 'sz_rma/item_entity',
                'increment_model'                => 'eav/entity_increment_numeric',
                'additional_attribute_table'     => 'sz_rma/item_eav_attribute',
                ...
                'attributes'                     => array(
                    ...
                    'status'                 => array(
                        ...
                        'label'              => 'Status',
                        'input'              => 'select',
                        'source'             => 'sz_rma/item_attribute_source_status',
                        'visible'            => false,
                        'sort_order'         => 60,
                        'position'           => 60,
                        'adminhtml_only'     => 1,
    ...
    public function installForms()
    {
        ...
        if ($data) {
            $this->getConnection()->insertMultiple($this->getTable('sz_rma/item_form_attribute'), $data);
        }
    }
}
