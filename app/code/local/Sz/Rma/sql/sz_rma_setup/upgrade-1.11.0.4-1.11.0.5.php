...
/**
 * Create table 'sz_rma/rma_shipping_label'
 */
$table = $installer->getConnection()
    ->newTable($installer->getTable('sz_rma/rma_shipping_label'))
    ...
    ->addForeignKey(
        $installer->getFkName('sz_rma/rma_shipping_label', 'rma_entity_id', 'sz_rma/rma', 'entity_id'),
        'rma_entity_id',
