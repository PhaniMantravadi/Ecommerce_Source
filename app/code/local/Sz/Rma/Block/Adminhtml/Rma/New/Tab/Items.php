 ...
 */
class Sz_Rma_Block_Adminhtml_Rma_New_Tab_Items extends Mage_Adminhtml_Block_Widget_Form
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    {
        $addButtonData = array(
            'label' => Mage::helper('sz_rma')->__('Add Products'),
    ...
    {
        $addButtonData = array(
            'label' => Mage::helper('sz_rma')->__('Add Selected Product(s) to RMA'),
     ...
     *
     * @return Sz_Rma_Block_Adminhtml_Rma_New_Tab_Items
     */
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('product_name', 'text', array(
            'label'=> Mage::helper('sz_rma')->__('Product Name'),
            'name' => 'product_name',
            'required'  => false
        ));

        $fieldset->addField('product_sku', 'text', array(
            'label'=> Mage::helper('sz_rma')->__('SKU'),
            'name' => 'product_sku',
            'required'  => false
        ));
        ...
        $fieldset->addField('qty_ordered', 'text', array(
            'label'=> Mage::helper('sz_rma')->__('Remaining Qty'),
            'name' => 'qty_ordered',
            'required'  => false,
        ));

        $fieldset->addField('qty_requested', 'text', array(
            'label'=> Mage::helper('sz_rma')->__('Requested Qty'),
            'name' => 'qty_requested',
            'required' => false,
        ...
        $reasonOtherAttribute =
            Mage::getModel('sz_rma/item_form')->setFormCode('default')->getAttribute('reason_other');
        ...
        $fieldset->addField('reason', 'select', array(
            'label'=> Mage::helper('sz_rma')->__('Reason to Return'),
            'options' => array(''=>'')
                + Mage::helper('sz_rma/eav')->getAttributeOptionValues('reason')
                + array('other' => $reasonOtherAttribute->getStoreLabel()),
            'name' => 'reason',
            'required' => false
        ))->setRenderer(
            $this->getLayout()->createBlock('sz_rma/adminhtml_rma_new_tab_items_renderer_reason')
        );

        $fieldset->addField('condition', 'select', array(
            'label'=> Mage::helper('sz_rma')->__('Item Condition'),
        ...
        $fieldset->addField('resolution', 'select', array(
            'label'=> Mage::helper('sz_rma')->__('Resolution'),
        ...
        $fieldset->addField('delete_link', 'label', array(
            'label'=> Mage::helper('sz_rma')->__('Delete'),
            'name' => 'delete_link',
            'required' => false
        ));

        $fieldset->addField('add_details_link', 'label', array(
            'label'=> Mage::helper('sz_rma')->__('Add Details'),
    ...
    {
        return Mage::helper('sz_rma')->__('Items');
    }
    ...
    {
        return Mage::helper('sz_rma')->__('RMA Items');
    }
