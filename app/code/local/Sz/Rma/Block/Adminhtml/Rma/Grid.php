 ...
 */
class Sz_Rma_Block_Adminhtml_Rma_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Initialize grid
     */
    ...
    protected function _prepareColumns()
    {
        $this->addColumn('increment_id', array(
            'header' => Mage::helper('sz_rma')->__('RMA #'),
            'width'  => '50px',
            'type'   => 'number',
            'index'  => 'increment_id'
        ));
        ...
        $this->addColumn('date_requested', array(
            'header' => Mage::helper('sz_rma')->__('Date Requested'),
        ...
        $this->addColumn('order_increment_id', array(
            'header' => Mage::helper('sz_rma')->__('Order #'),
            'width'  => '50px',
            'type'   => 'number',
        ...
        $this->addColumn('order_date', array(
            'header' => Mage::helper('sz_rma')->__('Order Date'),
            'index' => 'order_date',
            'type' => 'datetime',
            'html_decorators' => array('nobr'),
            'width' => 1,
        ...
        $this->addColumn('customer_name', array(
            'header' => Mage::helper('sz_rma')->__('Customer Name'),
            'index' => 'customer_name',
        ));
        ...
        $this->addColumn('status', array(
            ...
            'type'    => 'options',
            'width'   => '100px',
            'options' => Mage::getModel('sz_rma/rma')->getAllStatuses()
        ));
        ...
        $this->addColumn('action',
            array(
                ...
                'actions'   => array(
                    array(
                        'caption'   => Mage::helper('sz_rma')->__('View'),
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('status', array(
            'label'=> Mage::helper('sz_rma')->__('Close'),
            'url'  => $this->getUrl($this->_getControllerUrl('close')),
            'confirm'  => Mage::helper('sz_rma')->__("You have chosen to change status(es) of the selected RMA requests to Close.\nAre you sure you want to proceed?")
        ));
