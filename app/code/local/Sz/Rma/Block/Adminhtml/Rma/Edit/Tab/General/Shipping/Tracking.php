...
class Sz_Rma_Block_Adminhtml_Rma_Edit_Tab_General_Shipping_Tracking extends Mage_Adminhtml_Block_Template
{
    /**
    ...
    {
        return Mage::helper('sz_rma')->getAllowedShippingCarriers($this->getRma()->getStoreId());
    }
    ...
    {
        return Mage::getResourceModel('sz_rma/shipping_collection')
     ...
     * Retrieve remove url
     *
     * @param Sz_Rma_Model_Shipping $track
     * @return string
     */
