 ...
 */
class Sz_Rma_Block_Adminhtml_Rma_Item_Attribute extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    /**
    ...
    public function _construct()
    {
        ...
        $this->_headerText = Mage::helper('sz_rma')->__('Manage RMA Item Attribute');
        $this->_addButtonLabel = Mage::helper('sz_rma')->__('Add New Attribute');
        parent::_construct();
    }
}
