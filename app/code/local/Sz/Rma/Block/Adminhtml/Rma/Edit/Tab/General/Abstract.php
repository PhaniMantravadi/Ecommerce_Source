 ...
 */
class Sz_Rma_Block_Adminhtml_Rma_Edit_Tab_General_Abstract extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     ...
     *
     * @return Sz_Rma_Block_Adminhtml_Rma_Edit_Tab_General_Absract
     */
