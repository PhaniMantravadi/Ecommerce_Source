 ...
 */
class Sz_Rma_Block_Adminhtml_Rma_Edit_Tab_General_Shipping_Grid extends Mage_Adminhtml_Block_Template
{
    /**
     * Constructor
     */
    ...
    public function displayCustomsValue()
    {
        ...
        $shippingDestinationInfo = Mage::helper('sz_rma')->getReturnAddressModel($storeId);
