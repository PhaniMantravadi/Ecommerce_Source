...
class Sz_Rma_Block_Adminhtml_Rma_Create_Order_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        parent::_construct();
        $this->setId('sz_rma_rma_create_order_grid');
     ...
     *
     * @return Sz_Rma_Block_Adminhtml_Rma_Create_Order_Grid
     */
