 ...
 */
class Sz_Rma_Block_Adminhtml_Rma_Edit_Tab_Items_Grid_Column_Renderer_Reasonselect
    extends Sz_Rma_Block_Adminhtml_Rma_Edit_Tab_Items_Grid_Column_Renderer_Abstract
{
    ...
    {
        /** @var $rmaItemAttribute Sz_Rma_Model_Item_Attribute */
        $rmaItemAttribute = Mage::getModel('sz_rma/item_form')
            ->setFormCode('default')
