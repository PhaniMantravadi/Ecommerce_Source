...
class Sz_Rma_Block_Adminhtml_Rma_New_Tab_Items_Grid
    extends Mage_Adminhtml_Block_Widget_Grid
//    extends Sz_Rma_Block_Adminhtml_Rma_Edit_Tab_Items_Grid
{
    /**
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('reason', array(
            ...
            'type'  => 'select',
            'options' => array(''=>'') + Mage::helper('sz_rma/eav')->getAttributeOptionValues('reason'),
            'index' => 'reason',
            'sortable' => false
        ));
        ...
        $this->addColumn('condition', array(
            ...
            'width' => '80px',
            'type'  => 'select',
            'options' => array(''=>'') + Mage::helper('sz_rma/eav')->getAttributeOptionValues('condition'),
            'index' => 'condition',
            'sortable' => false
        ));
        ...
        $this->addColumn('resolution', array(
            ...
            'index' => 'resolution',
            'type'  => 'select',
            'options' => array(''=>'') + Mage::helper('sz_rma/eav')->getAttributeOptionValues('resolution'),
            'sortable' => false
        ));

        $actionsArray = array(
            array(
                'caption'   => Mage::helper('sz_rma')->__('Delete'),
                'url'       => array('base'=> '*/*/delete'),
                'field'     => 'id',
                'onclick'  => 'alert(\'Delete\');return false;'
            ),
            array(
                'caption'   => Mage::helper('sz_rma')->__('Add Details'),
                'url'       => array('base'=> '*/*/edit'),
                'field'     => 'id',
