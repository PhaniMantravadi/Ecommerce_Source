...
class Sz_Rma_Block_Adminhtml_Rma_Edit_Tab_General_Shipping_Packaging extends Mage_Adminhtml_Block_Template
{
    /**
    ...
    {
        return Mage::helper('sz_rma')->getCarrier(
    ...
    public function getContainers()
    {
        ...
        $countryRecipient = Mage::helper('sz_rma')->getReturnAddressModel($storeId)->getCountryId();
        if ($carrier) {
    ...
    public function displayCustomsValue()
    {
        ...
        $recipientAddressCountryCode    = Mage::helper('sz_rma')
    ...
    public function getCustomizableContainersStatus()
    {
        $storeId = $this->getRma()->getStoreId();
        $code    = $this->getRequest()->getParam('method');
        $carrier = Mage::helper('sz_rma')->getCarrier($code, $storeId);
        if ($carrier) {
