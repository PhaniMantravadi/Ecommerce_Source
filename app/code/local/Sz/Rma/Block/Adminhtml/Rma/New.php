...
class Sz_Rma_Block_Adminhtml_Rma_New extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->_updateButton('reset', 'label', Mage::helper('sz_rma')->__('Cancel'));
        ...
        if (Mage::helper('sz_rma')->canCreateRma($orderId, true)) {
            ...
            $this->_updateButton('save', 'label', Mage::helper('sz_rma')->__('Submit RMA'));
        } else {
            $this->_updateButton('reset', 'onclick', "setLocation('" . $link . "')");
    ...
    {
        return $this->getLayout()->createBlock('sz_rma/adminhtml_rma_create_header')->toHtml();
    }
