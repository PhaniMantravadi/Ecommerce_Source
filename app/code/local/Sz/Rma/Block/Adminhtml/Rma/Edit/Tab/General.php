 ...
 */
class Sz_Rma_Block_Adminhtml_Rma_Edit_Tab_General extends Mage_Adminhtml_Block_Widget_Form
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    /**
     * Create form. Fieldset are being added in child blocks
     *
     * @return Sz_Rma_Block_Adminhtml_Rma_Edit_Tab_General
     */
    ...
    {
        return Mage::helper('sz_rma')->__('General Information');
    }
