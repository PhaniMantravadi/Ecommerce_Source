...
class Sz_Rma_Block_Adminhtml_Rma_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function __construct()
    {
        ...
        if (!$statusIsClosed) {
            $this->_addButton('save_and_edit_button', array(
                    'label'   => Mage::helper('sz_rma')->__('Save and Continue Edit'),
            ...
            $this->_addButton('close', array(
                ...
                'onclick'   => 'confirmSetLocation(\''
                                . Mage::helper('sz_rma')->__('Are you sure you want to close this RMA request?')
                                .'\', \'' . $this->getCloseUrl().'\')'
                )
            );
        } else {
    ...
    public function getHeaderText()
    {
        if ($this->getRma()->getId()) {
            return Mage::helper('sz_rma')->__('RMA #%s - %s', intval($this->getRma()->getIncrementId()), $this->getRma()->getStatusLabel());
        }
