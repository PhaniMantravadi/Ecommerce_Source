 ...
 */
class Sz_Rma_Block_Adminhtml_Rma_Item_Attribute_Edit
    extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function __construct()
    {
        ...
        $this->_updateButton('save', 'label', Mage::helper('sz_rma')->__('Save Attribute'));

        if (!$this->_getAttribute()->getIsUserDefined()) {
            $this->_removeButton('delete');
        } else {
            $this->_updateButton('delete', 'label', Mage::helper('sz_rma')->__('Delete Attribute'));
        }
    }
    ...
    public function getHeaderText()
    {
        if ($this->_getAttribute()->getId()) {
            ...
            return Mage::helper('sz_rma')->__('Edit RMA Item Attribute "%s"', $label);
        } else {
            return Mage::helper('sz_rma')->__('New RMA Item Attribute');
        }
    }
