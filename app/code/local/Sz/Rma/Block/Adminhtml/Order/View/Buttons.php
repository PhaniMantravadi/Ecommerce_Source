 ...
 */
class Sz_Rma_Block_Adminhtml_Order_View_Buttons extends Mage_Adminhtml_Block_Sales_Order_View
{
    /**
    ...
    public function addButtons()
    {
        ...
        if ($container instanceof Mage_Adminhtml_Block_Template && $container->getOrderId()) {
            $isReturnable = Mage::helper('sz_rma')->canCreateRma($container->getOrder(), true);
            if ($isReturnable) {
                ...
                $container->addButton('create_rma', array(
                    'label' => Mage::helper('sz_rma')->__('Create RMA'),
