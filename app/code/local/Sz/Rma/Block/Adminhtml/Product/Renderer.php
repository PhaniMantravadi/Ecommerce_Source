 ...
 */
class Sz_Rma_Block_Adminhtml_Product_Renderer extends Varien_Data_Form_Element_Select
{
    /**
    ...
    public function getElementHtml()
    {
        if (is_null($this->getValue())) {
            $this->setValue(Sz_Rma_Model_Product_Source::ATTRIBUTE_ENABLE_RMA_USE_CONFIG);
        }
