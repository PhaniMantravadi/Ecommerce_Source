...
class Sz_Rma_Block_Return_Create extends Sz_Rma_Block_Form
{
    public function _construct()
    {
        ...
        $items = Mage::helper('sz_rma')->getOrderItems($order);
        $this->setItems($items);
     ...
     *
     * @param $a Sz_Rma_Model_Item_Attribute
     * @param $b Sz_Rma_Model_Item_Attribute
     *
     * @return int
     */
    protected function _compareSortOrder(Sz_Rma_Model_Item_Attribute $a, Sz_Rma_Model_Item_Attribute $b)
    {
