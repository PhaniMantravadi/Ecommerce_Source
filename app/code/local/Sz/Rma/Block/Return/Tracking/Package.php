...
class Sz_Rma_Block_Return_Tracking_Package extends Mage_Shipping_Block_Tracking_Popup
{
    /**
     * Class constructor
     */
    ...
    public function getContainerTypeByCode($code)
    {
        ...
        $carrier    = Mage::helper('sz_rma')->getCarrier($carrierCode, Mage::app()->getStore()->getId());
        if ($carrier) {
