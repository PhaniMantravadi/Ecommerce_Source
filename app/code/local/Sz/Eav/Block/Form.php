 ...
 */
class Sz_Eav_Block_Form extends Mage_Core_Block_Template
{
    /**
    ...
    protected function _prepareLayout()
    {
        if (empty($this->_xmlBlockName)) {
            Mage::throwException(Mage::helper('sz_eav')->__('Current module XML block name is undefined'));
        }
        if (empty($this->_formModelPath)) {
            Mage::throwException(Mage::helper('sz_eav')->__('Current module form model pathname is undefined'));
        }

        /* $var $template Sz_Eav_Block_Form_Template */
     ...
     *
     * @param string $type
     * @return Sz_Eav_Block_Form_Renderer_Abstract
     */
